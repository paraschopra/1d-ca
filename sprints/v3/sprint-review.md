...
**Files modified**: `index.html` (+124 lines), `tests/metric-tooltips.js` (new, 361 lines)
...
**File**: `index.html` (lines 442–494, CSS section)
...
**File**: `index.html`, `formatMetricsHTML()` function (lines 1792–1804)
...
**File**: `index.html`, `openModal()` function (lines 2011–2022)
...
**File**: `index.html`, `buildPhaseCheckboxes()` IIFE (lines 2520–2522)
